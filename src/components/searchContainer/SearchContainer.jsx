...
const SearchContainer = ()=>{
    ...
    return (
          <section className={`fixed top-[16.2%]  right-0 left-0 bottom-0 
           z-[999] bg-[#3c3c3c80]  ${openModal ? "block":"hidden"}`}> 
                <div className="flex gap-4 justify-center items-start mt-16 ">
                <div className=" flex-[0.67]
                bg-gradient-to-l  to-[#BB0000]  from-[#880000]   rounded-md h-[500px]   overflow-y-scroll">
                <SearchCard/>
                </div>
                <CiCircleRemove onClick={handleModal} className="text-white cursor-pointer text-4xl font-[900]"/>
                </div>
            </section>
    )
}
