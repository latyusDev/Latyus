    ...
    return(
            <div className="py-9 px-4  ">
            {
              products.map(product=>{
                    ...
                    return (
                        <div  key={id} className="flex gap-5 mx-auto   mb-5 font-['Lato',sans-serif] items-end font-[3h00] ">
                           ...
                           <img src={image} alt={name} className="w-full h-full" />
                            ...
                            <div>
                                ...
                                <p className="text-white">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                 ...
                                 <AddToCart product={product} styles={"transition-all duration-1000 bg-[#88000l0] rounded-sm mr-3  mt-2 border-[1px] border-white text-white px-6 py-2 hover:text-[#FF9300]  hover:border-[#FF9300]"}/>
                                 
                                 <button className="transition-all duration-1000 capitalize mt-4 px-6 py-2  rounded-sm border-[1px] border-[#FF9300] text-[#FF9300]
