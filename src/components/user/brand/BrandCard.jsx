            ...
            <Slider {...settings}>
                ...
                return (
                    ...
                    text-center basis-[17%] hover:cursor-pointer transition-all duration-200 hover:shadow-lg hover:border-[0px]" key={product.id}>
                      ...
                      <AddToCart product={product} styles={"transition-all font-[600] bg-[#880000] rounded-sm  mt-2 text-white w-full py-2 border-[2px] border-[#880000] hover:bg-white hover:text-[#880000] hover:border-[2px] hover:border-[#880000]"}/>
                   </div>
